...
export default function FeatureCard({
  ...
  return (
    <div className="border border-primary rounded-md shadow-xs p-6 flex items-center flex-col gap-2 w-56 justify-center md:w-80 md:h-52 md:py-6 md:px-8 hover:shadow-lg text-primary-foreground md:items-start">
